...
include("test_topology_state.jl")
include("test_topology_detection_2d.jl")
include("test_topology_patch_2d.jl")
include("test_topology_reconstruction_2d.jl")
include("test_topology_merge_2d.jl")
include("test_topology_split_2d.jl")
include("test_topology_field_transfer_2d.jl")
include("test_topology_detection_3d.jl")
include("test_topology_reconstruction_3d.jl")
include("test_topology_merge_3d.jl")
include("test_topology_split_3d.jl")
